...
public class SimpleJdbcTemplateApp2
{
    public static void main( String[] args )
    {
        ...
        CustomerDAO customerSimpleDAO = getCustomerDAO(context, "customerSimpleDAO");
        dbOperationForCustomerDAO(customerSimpleDAO);

        CustomerDAO customerSimpleDAO2 = getCustomerDAO(context, "customerSimpleDAO2");
        dbOperationForCustomerDAO(customerSimpleDAO2);
    ...
    private static CustomerDAO getCustomerDAO(ApplicationContext context, String dao) {
        return (CustomerDAO) context.getBean(dao);
    }

    private static CustomerDAO dbOperationForCustomerDAO(CustomerDAO customerSimpleDAO) {
